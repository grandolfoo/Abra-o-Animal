...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .logo { color: var(--primary); font-size: 1.6rem; display: flex; align-items: center; gap: 10px; }
        ...
        @media (max-width: 768px) {
            ...
            nav { display: none; } /* Idealmente um menu hamburguer aqui */
        }
    </style>
</head>
<body>
    ...
    <header id="navbar">
        <div class="logo"><i class="fas fa-paw"></i> ABRAÇO ANIMAL</div>
        <nav>
            <ul>
    ...
    <section id="adotar" class="section-padding">
        ...
        <div class="pets-grid" id="petsContainer">
            <div class="pet-card" data-type="cachorro">
                ...
                <img src="https://images.unsplash.com/photo-1583511655857-d19b40a7a54e?w=500" class="pet-img" alt="Rodolfo">
                <div class="pet-info">
                    <h3>Rodolfo de Almeida</h3>
                    <p><i class="fas fa-venus-mars"></i> Macho | <i class="fas fa-dog"></i> Porte Pequeno</p>
                    <button class="btn-cta" style="margin-top:15px; width:100%" onclick="openModal('Rodolfo', 'Um cãozinho alegre e cheio de energia, resgatado na Zona Sul.')">Ver Dados</button>
                </div>
            </div>

            <div class="pet-card" data-type="gato">
                <span class="pet-tag">Gato</span>
                <img src="https://images.unsplash.com/photo-1514888286974-6c03e2ca1dba?w=500" class="pet-img" alt="Mimi">
                <div class="pet-info">
                    <h3>Mimi Aurora</h3>
                    <p><i class="fas fa-venus-mars"></i> Fêmea | <i class="fas fa-cat"></i> Filhote</p>
                    <button class="btn-cta" style="margin-top:15px; width:100%" onclick="openModal('Mimi Aurora', 'Dócil e ronronante, adora um colo e sachê de salmão.')">Ver Dados</button>
                </div>
            </div>
        </div>
    </section>
    ...
    <footer>
        <div class="footer-content">
            <div>
                ...
                <p>Fundada por Mateus Abreu, Matheus Lima, Maria Beatriz, Sarah e Lucas. Transformando a causa animal em São Paulo.</p>
            </div>
            <div>
                <h4>Contato</h4>
                <p><i class="fas fa-envelope"></i> abraçoanimal@gmail.com</p>
        ...
        <div style="text-align: center; margin-top: 50px; opacity: 0.6; font-size: 0.8rem;">
            CNPJ: 23.345.657/002-16 | &copy; 2026 Abraço Animal
        </div>
    </footer>
    ...
    <script>
        ...
        // 4. Animações de Entrada (ScrollReveal)
